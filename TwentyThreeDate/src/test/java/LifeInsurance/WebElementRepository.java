...
@FindBy(xpath =  "//input[@name='maritial_status']")
private WebElement maritial_status;
...
public WebElement getMaritial_status() {
...
@FindBy(xpath = "//td[text() ='1674629910']/..//a[text()='Edit']")
private WebElement ParticularClientEditOption;

@FindBy(xpath = "//input[@name='client_password']")
private WebElement client_password;

public WebElement getClient_password() {
...
//public ClientsRepository(WebDriver sp) {
