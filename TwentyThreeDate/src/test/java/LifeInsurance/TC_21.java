...
public class TC_21 extends HomePageInsurance{
	@Test(groups = "integration")
	public void addrress() throws InterruptedException {
	...
	addclient.getClientModule().click();
	WebElement referenceaddress =driver.findElement(By.xpath("//td[text()='name07']/..//td[text()='"+expectedaddress+"']"));
