...
public class TC_17 extends HomePageInsurance {
	@Test
	public void addClient() throws InterruptedException {
		...
		addclient.getName().sendKeys("henge naavu");
		...
		addclient.getClientModule().click();
		WebElement referenceid = driver.findElement(By.xpath("//td[text()='henge naavu']/..//td[text()='" + expectedclientid + "']"));
		...
		sassert.assertEquals(expectedclientid, actualID, "client id is not matching");
